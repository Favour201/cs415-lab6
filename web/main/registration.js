var Lab6A = (function(){
    ...
    var register = function(attendeeid) {
            $.ajax({
                url: "http://localhost:8189/Lab6A/main/Registrations.jsp",
                method: 'POST',
    ...
    var attendeeRegister = function() {
            $.ajax({
                url:"http://localhost:8180/Lab6A/AttendeeServlet",
                method: 'POST',
    ...
    var editReg = function(){
            $.ajax({
                url: "http://localhost:8180/Lab6A/main/Registrations.jsp",
                method: 'PUT',
    ...
    var editUser = function(){
            $.ajax({
                url: "http://localhost:8180/Lab6A/AttendeeServelet",
                method: 'PUT',
    ...
    return {
        ...
        getSessionsList: function(){
            $.ajax({
                url: "http:localhost:8180/Lab6A/TrainingSessionServlet",
                method: 'GET',
                datatype: 'json',
                success: function(response){
